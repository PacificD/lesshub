      ...
      <div>
        <div className='flex flex-col gap-2'>
          ...
          {value?.map(({ file, progress, url }, i) => (
            <div
              key={i}
              className='flex w-96 max-w-[100vw] flex-col justify-center rounded border border-gray-300 px-4 py-2'
            >
              ...
              {progress === 'COMPLETE' ? (
                <pre className='mt-2 items-center justify-between space-x-2 overflow-x-auto rounded-lg border border-neutral-100 bg-neutral-100 p-2 dark:border-neutral-700 dark:bg-black flex'>
                  <CopyButton
                    value={url || ''}
                  ...
                  <code
                    ...
                    className='text-start flex-1 whitespace-break-spaces cursor-pointer font-mono underline text-sm text-neutral-900 dark:text-neutral-50 mr-4'
                  >
                    {url || ''}
                  </code>
                </pre>
